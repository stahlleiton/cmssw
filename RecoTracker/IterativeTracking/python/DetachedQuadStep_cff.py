...
(highBetaStar_2018 | highBetaStar_2023).toModify(detachedQuadStepTrackingRegions,RegionPSet = dict(ptMin = 0.05))
...
(highBetaStar_2018 | highBetaStar_2023).toModify(detachedQuadStepHitQuadruplets,CAThetaCut = 0.0022,CAPhiCut = 0.1)
...
(highBetaStar_2018 | highBetaStar_2023).toModify(detachedQuadStep,qualityCuts = [-0.7,0.0,0.5])
