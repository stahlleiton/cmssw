...
(highBetaStar_2018 | highBetaStar_2023).toModify(highPtTripletStepTrackingRegions,RegionPSet = dict(
     ptMin        = 0.05,
     originRadius = 0.2
))
...
(highBetaStar_2018 | highBetaStar_2023).toModify(highPtTripletStepHitTriplets,CAThetaCut = 0.008,CAPhiCut = 0.14,CAHardPtCut = 0)
...
(highBetaStar_2018 | highBetaStar_2023).toModify(highPtTripletStepTrajectoryFilterBase, minPt=0.05)
...
(highBetaStar_2018 | highBetaStar_2023).toModify(highPtTripletStepTrajectoryFilterInOut, minPt=0.05)
...
(highBetaStar_2018 | highBetaStar_2023).toModify(highPtTripletStep,qualityCuts = [-0.2,0.3,0.4])
