...
(highBetaStar_2018 | highBetaStar_2023).toModify(mixedTripletStepSeedLayersA,
    layerList = [
        'BPix1+BPix2+BPix3',
        'BPix1+FPix1_pos+FPix2_pos','BPix1+FPix1_neg+FPix2_neg',
        'BPix2+FPix1_pos+FPix2_pos','BPix2+FPix1_neg+FPix2_neg',
...
(highBetaStar_2018 | highBetaStar_2023).toModify(_mixedTripletStepTrackingRegionsCommon,RegionPSet = dict(
     ptMin        = 0.05,
     originRadius = 0.2
))
...
(highBetaStar_2018 | highBetaStar_2023).toReplaceWith(mixedTripletStepTrackingRegionsB, _mixedTripletStepTrackingRegionsCommon.clone())
...
(highBetaStar_2018 | highBetaStar_2023).toModify(_mixedTripletStepTrajectoryFilterBase,minPt = 0.05)
...
(highBetaStar_2018 | highBetaStar_2023).toModify(mixedTripletStepPropagator,ptMin = 0.05)
...
(highBetaStar_2018 | highBetaStar_2023).toModify(mixedTripletStepPropagatorOpposite,ptMin = 0.05)
...
(highBetaStar_2018 | highBetaStar_2023).toModify(mixedTripletStep,qualityCuts = [-0.7,0.0,0.5])
