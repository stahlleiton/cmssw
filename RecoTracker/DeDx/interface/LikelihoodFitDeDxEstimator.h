...
private:
  void calculate_wrt_epsilon(const reco::DeDxHit&, const double&, std::vector<double>&);
  void functionEpsilon(const reco::DeDxHitCollection&, const double&, std::vector<double>&);
