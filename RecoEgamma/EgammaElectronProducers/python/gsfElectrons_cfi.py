...
(pp_on_AA & ~pp_on_AA_v1).toModify(ecalDrivenGsfElectrons.preselection, minSCEtBarrel = 15.0)
(pp_on_AA & ~pp_on_AA_v1).toModify(ecalDrivenGsfElectrons.preselection, minSCEtEndcaps = 15.0)
