...
class HLTPixelTrackFilter2 : public HLTFilter {
public:
  explicit HLTPixelTrackFilter2(const edm::ParameterSet&);
  ~HLTPixelTrackFilter2() override;
...
HLTPixelTrackFilter2::HLTPixelTrackFilter2(const edm::ParameterSet& config)
    : HLTFilter(config),
...
HLTPixelTrackFilter2::~HLTPixelTrackFilter2() = default;

void HLTPixelTrackFilter2::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
bool HLTPixelTrackFilter2::hltFilter(edm::Event& event, const edm::EventSetup& iSetup, trigger::TriggerFilterObjectWithRefs& filterproduct) const {
...
DEFINE_FWK_MODULE(HLTPixelTrackFilter2);
