...
def customise_gpu_pixel(process):
    ...
    process.HLTPixelVertexingPPOnAASequence = cms.Sequence(process.HLTPixelVertexingSequencePPOnAA)
    process.HLTRecopixelvertexingSequencePPOnAA = cms.Sequence(process.HLTPixelVertexingSequencePPOnAA)
