...
process.HiForestInfo.info = cms.vstring("HiForest, AOD+PAT, 132X, data")
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        '/store/hidata/HIRun2023A/HIForward0/AOD/16Jan2024-v1/2810000/56d51699-8f3d-4ecf-9b30-22a050ad1a51.root'
    ),
)
...
process.load('HeavyIonsAnalysis.EventAnalysis.primaryVertexRecoveryForUPC_cfi')
...
if addR3Jets or addR3FlowJets or addR4Jets or addR4FlowJets or addUnsubtractedR4Jets :
    ...
    if addR4FlowJets :
        ...
        process.akCs4PFFlowpatJets.addJetCharge = False
...
from HeavyIonsAnalysis.EventAnalysis.collisionEventSelection_cff import clusterCompatibilityFilter, primaryVertexFilter
process.clusterCompatibilityFilter = clusterCompatibilityFilter.clone()
process.pvFilter = primaryVertexFilter.clone()
process.pclusterCompatibilityFilter = cms.Path(process.clusterCompatibilityFilter)
process.pprimaryVertexFilter = cms.Path(process.primaryVertexRecoveryForUPC + process.pvFilter)
...
# Change to recover vertices
from Configuration.Applications.ConfigBuilder import MassReplaceInputTag
MassReplaceInputTag(process, new="primaryVertexRecoveryForUPC", old="offlinePrimaryVertices")
process.primaryVertexRecoveryForUPC.primaryVertexLabel = "offlinePrimaryVertices"
