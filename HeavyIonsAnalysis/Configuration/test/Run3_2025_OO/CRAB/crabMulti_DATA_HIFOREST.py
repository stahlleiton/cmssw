...
config.Data.outLFNDirBase = '/store/group/cmst3/group/hintt/Run3_2025_OO/HiForest/'+date+'/DATA/PHOLEP'
...
config.Data.lumiMask = '/eos/user/c/cmsdqm/www/CAF/certification/Collisions25OO/Cert_Collisions2025OO_394153_394217_golden.json'
config.Data.inputDBS = 'global'
## Submit the muon PDs
for i in range(0, 60, 1):
    config.General.requestName = f'HiForest_IonPhysics{i}_OORun2025_PromptReco_v1_PHOLEPSKIM_'+date
