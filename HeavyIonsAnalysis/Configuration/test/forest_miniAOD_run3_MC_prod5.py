...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        '/store/user/nsaha/MinBias/Starlight_prod5_miniAOD/221127_173130/0000/step4_PAT_1.root',
        '/store/user/nsaha/MinBias/Starlight_prod5_miniAOD/221127_173130/0000/step4_PAT_2.root',
        '/store/user/nsaha/MinBias/Starlight_prod5_miniAOD/221127_173130/0000/step4_PAT_3.root',
        '/store/user/nsaha/MinBias/Starlight_prod5_miniAOD/221127_173130/0000/step4_PAT_4.root',
        '/store/user/nsaha/MinBias/Starlight_prod5_miniAOD/221127_173130/0000/step4_PAT_5.root',
        #'/store/user/nsaha/MinBias/Starlight_prod5_miniAOD/221127_173130/0000/step4_PAT_6.root',
        #'/store/user/nsaha/MinBias/Starlight_prod5_miniAOD/221127_173130/0000/step4_PAT_7.root',
        #'/store/user/nsaha/MinBias/Starlight_prod5_miniAOD/221127_173130/0000/step4_PAT_8.root',
        #'/store/user/nsaha/MinBias/Starlight_prod5_miniAOD/221127_173130/0000/step4_PAT_9.root',
        #'/store/user/nsaha/MinBias/Starlight_prod5_miniAOD/221127_173130/0000/step4_PAT_10.root',
        #'/store/user/nsaha/MinBias/Starlight_prod5_miniAOD/221127_173130/0000/step4_PAT_11.root',
    ),
)

# number of events to process, set to -1 to process all events
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(4999)
    )
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string("HiForestMiniAOD_Starlight_prod5___________.root"))
