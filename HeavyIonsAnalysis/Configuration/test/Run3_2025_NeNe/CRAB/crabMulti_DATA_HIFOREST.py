...
config.Data.outLFNDirBase = '/store/group/cmst3/group/hintt/Run3_2025_NeNe/HiForest/'+date+'/DATA/PHOLEP'
...
config.Data.lumiMask = '/eos/user/c/cmsdqm/www/CAF/certification/Collisions25NeNe/Cert_Collisions2025Nene_394269_394272_golden.json'
config.Data.inputDBS = 'global'
## Submit the muon PDs
for i in range(0, 60, 1):
    config.General.requestName = f'HiForest_IonPhysics{i}_NeNeRun2025_PromptReco_v1_PHOLEPSKIM_'+date
    config.Data.inputDataset = f'/IonPhysics{i}/NeNeRun2025-PromptReco-v1/MINIAOD'
