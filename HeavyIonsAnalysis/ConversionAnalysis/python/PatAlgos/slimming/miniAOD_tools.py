...
def includeMETFilters(process):
    ...
    metFilterPaths = [ process.Flag_collisionEventSelectionPA , process.Flag_collisionEventSelectionPA_rejectPU , process.Flag_HBHENoiseFilter , 
                       ...
                       process.Flag_eeBadScFilter ,  process.Flag_trkPOGFilters , process.Flag_chargedHadronTrackResolutionFilter, 
                       process.Flag_muonBadTrackFilter , process.Flag_BadChargedCandidateFilter , process.Flag_BadPFMuonFilter , process.Flag_BadChargedCandidateSummer16Filter,
                       process.Flag_BadPFMuonSummer16Filter , process.Flag_trkPOG_manystripclus53X , process.Flag_trkPOG_toomanystripclus53X , process.Flag_trkPOG_logErrorTooManyClusters,
                       process.Flag_noBadMuons, process.Flag_badMuons, process.Flag_duplicateMuons , process.Flag_ecalLaserCorrFilter , process.Flag_badTrackerMuons ]
