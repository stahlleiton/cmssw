...
dataMap = {
            "HIEmptyBX": { "PD": "/HIEmptyBX/HIRun2018A-27Feb2019-v1/AOD", "Units": 45, "Memory": 2400, "RunTime": 1400, "PSet": "runForestAOD_CMSDAS_DATA_EmptyBX_103X.py" },
            }

## Submit the muon PDs
for key, val in dataMap.items():
    config.General.requestName = 'HiForest_'+key+'_HIRun2018_04Apr2019_CMSDAS_20230605'
