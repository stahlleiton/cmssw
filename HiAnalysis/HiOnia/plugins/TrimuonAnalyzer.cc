...
std::pair<bool, reco::GenParticleRef> HiOniaAnalyzer::findBcMotherRef(reco::GenParticleRef GenParticleMother, int BcPDG){
...
std::pair<int, std::pair<float, float> > HiOniaAnalyzer::findGenBcInfo(reco::GenParticleRef genBc, const reco::GenParticle* genJpsi) {
