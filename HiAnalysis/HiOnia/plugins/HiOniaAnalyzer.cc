  ...
  if (collJpsi.isValid()) {
    for(std::vector<pat::CompositeCandidate>::const_iterator it=collJpsi->begin();
      ...
      if (thisSign) {
        ...
        if ( _muonSel==(std::string)("Glb") || _muonSel==(std::string)("GlbTrk") ) {
...
HiOniaAnalyzer::fillRecoMuons(int iCent)
{
  ...
  if (collMuon.isValid()) {
    for(vector<pat::Muon>::const_iterator it=collMuon->begin();
      ...
      if ( ( ( _muonSel==(std::string)("Glb") || _muonSel==(std::string)("GlbTrk") ) && ((muType&1)==1) ) ||
           ( ( _muonSel==(std::string)("Trk") ) && ((muType&2)==2) ) 
           ) {
        nGoodMuons++;
