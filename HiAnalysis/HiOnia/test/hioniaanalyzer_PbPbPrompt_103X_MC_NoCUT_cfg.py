...
muonSelection  = "All" # Single muon selection: Glb(isGlobal), GlbTrk(isGlobal&&isTracker), Trk(isTracker), GlbOrTrk, TwoGlbAmongThree (which requires two isGlobal for a trimuon, and one isGlobal for a dimuon) are available
...
options.inputFiles =['/store/himc/HINPbPbAutumn18DR/DYJetsToLL_MLL-50_TuneCP5_HydjetDrumMB_5p02TeV-amcatnloFXFX-pythia8/AODSIM/mva98_103X_upgrade2018_realistic_HI_v11-v1/70003/FABA33C0-C8C5-9E4D-AEDB-48A33CC53415.root']
...
oniaTreeAnalyzer(process,
                 ...
                 muonSelection=muonSelection, useL1Stage2=True, isMC=isMC, pdgID=23, outputFileName=options.outputFile, doTrimu=doTrimuons)

process.onia2MuMuPatGlbGlb.dimuonSelection = cms.string("")
process.onia2MuMuPatGlbGlb.LatDiMuonSel = cms.string("")
...
process.hionia.useGeTracks      = cms.untracked.bool(True) #for Reco_trk_*
process.hionia.fillRecoTracks   = cms.bool(False)           #for Reco_trk_*
