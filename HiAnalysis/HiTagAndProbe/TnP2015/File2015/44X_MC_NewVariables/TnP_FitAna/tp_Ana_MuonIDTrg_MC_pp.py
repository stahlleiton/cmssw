...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    InputFileNames = cms.vstring("/afs/cern.ch/work/e/echapon/public/TnP_2015/TP_Prod_Samples/MC_pp/tnp_Prod_pp_MC_All_16092015.root"),
    ...
    PDFs = cms.PSet(
      ...
      cbPlusPoly1 = cms.vstring(
        "Gaussian::signal1(mass, mean[3.1,3.0,3.2], sigma[0.02, 0.01, 0.1])",
        "CBShape::signal2(mass, mean, sigma2[0.02, 0.005, 0.1], alpha[2.0, 0.2, 10.0], n[4, 0.5, 500.])",
        ...
        #"CBShape::signal(mass, mean[3.1,3.0,3.2], sigma[0.02, 0.01, 0.1], alpha[1.0, 0.5, 4.0], n[1, 0.5, 100.])",
        "Chebychev::backgroundPass(mass, {cPass[-1,-5.0,5.0]})",
        "Chebychev::backgroundFail(mass, {cFail[-1,-5.0,5.0]})",
        #"Chebychev::backgroundPass(mass, {cPass[0,-0.5,0.5], cPass2[0,-0.5,0.5]})",
        #"Chebychev::backgroundFail(mass, {cFail[0,-0.5,0.5], cFail2[0,-0.5,0.5]})",
        "efficiency[0.9,0,1]",
        "signalFractionInPassing[0.9]"
      ...
      cbPlusPoly2 = cms.vstring(
        "Gaussian::signal1(mass, mean[3.1,3.0,3.2], sigma[0.02, 0.01, 0.1])",
        "CBShape::signal2(mass, mean, sigma2[0.02, 0.005, 0.1], alpha[2.0, 0.2, 10.0], n[4, 0.5, 100.])",
        "SUM::signalPass(fracP[0.8,0,1]*signal1,signal2)",
        "SUM::signalFail(fracF[0.8,0,1]*signal1,signal2)",
        #"CBShape::signal1(mass, mean[3.1,3.0,3.2], sigma[0.02, 0.01, 0.1], alpha[2.0, 1.0, 5.0], n[1, 0.5, 100.])",
        #"Gaussian::signal2(mass, mean, sigma2[0.02, 0.01, 0.1])",
    ...
    Efficiencies = cms.PSet(
          ...
          PassingGlb_pt1 = cms.PSet(
             ...
             BinnedVariables = cms.PSet(
                    pt = cms.vdouble(3.4, 3.75, 4, 4.25, 4.5, 4.75, 5, 5.25, 5.5, 6, 6.5, 9, 30),
          ...
          PassingGlb_pt2 = cms.PSet(
             ...
             UnbinnedVariables = cms.vstring("mass"),
             BinnedVariables = cms.PSet(
                    pt = cms.vdouble(2.1, 2.3, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.25, 4.5, 4.75, 5, 5.5, 6, 8.5, 30),
          ...
          PassingGlb_pt3 = cms.PSet(
             ...
             UnbinnedVariables = cms.vstring("mass"),
             BinnedVariables = cms.PSet(
                    pt = cms.vdouble(1.7, 1.85, 2, 2.25, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.25, 4.5, 5, 5.5, 8, 30),
          ...
          PassingGlb_pt4 = cms.PSet(
             ...
             UnbinnedVariables = cms.vstring("mass"),
             BinnedVariables = cms.PSet(
                    pt = cms.vdouble(1.5,1.75,2,2.25,2.5,2.75,3,3.25,3.5,3.75,4,4.5,5,7.5,30),
