...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    # IO parameters:
    InputFileNames = cms.vstring("tnp_Prod_pp_GTrkSTA_MC_24092015.root"),
    InputDirectoryName = cms.string("tpTree"),
    InputTreeName = cms.string("fitter_tree"),
    #numbrer of CPUs to use for fitting
    OutputFileName = cms.string("tnp_Ana_pp_STA_MC_4absetabins.root"),
    NumCPU = cms.uint32(4),
    ...
    PDFs = cms.PSet(
      ...
      twoGaussPlusPoly6v1 = cms.vstring(
          "Gaussian::signal1(mass, mean[3.1,3.0,3.2], sigma[0.02,0.01,1.00])",
          "Gaussian::signal2(mass, mean1[3.15,3.05,3.25], sigma2[0.2,0.05,1.00])",
          "SUM::signal(vFrac[0.8,0,1]*signal1, signal2)",
          "Chebychev::backgroundPass(mass, {cP[0,-.6,.6], cP2[0,-.6,.6]})",
          "Chebychev::backgroundFail(mass, {cF[0,-.6,.6], cF2[0,-.6,.6]})",
          "efficiency[0.9,0,1]",
          "signalFractionInPassing[0.9]"
      ),
       cbPlusPoly = cms.vstring(
        "CBShape::signal(mass, mean[3.08,3.0,3.2], sigma[0.01, 0.0, 0.1], alpha[2.0, 1.0, 10.0], n[4, 0.5, 100.])",
       ...
       cbGausPlusPoly = cms.vstring(
        "CBShape::signal1(mass, mean[3.095,3.0,3.2], sigma[0.02, 0.01, 0.1], alpha[1.5, 1.0, 10.0], n[3, 0.5, 100.])",
        "Gaussian::signal2(mass, mean2[3.1,3.05,3.3], sigma2[0.10,0.05,1.00])",
        "SUM::signalPass(fracP[0.8,0,1]*signal1, signal2)",
        "SUM::signalFail(fracF[0.8,0,1]*signal1,signal2)",
    ...
    Efficiencies = cms.PSet(
        ...
        PassingSTA_pt1 = cms.PSet(
            ...
            BinnedVariables = cms.PSet(
              pt = cms.vdouble(3.4, 3.75, 4, 4.25, 4.5, 4.75, 5, 5.25, 5.5, 5.75, 6, 6.5, 7, 7.5, 8.5, 10, 30),
         ...
         PassingSTA_pt2 = cms.PSet(
            ...
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
               pt = cms.vdouble(2.1, 2.5, 3, 3.25, 3.5, 3.75, 4, 4.25, 4.5, 5, 5.5, 7, 30),
         ...
         PassingSTA_pt3 = cms.PSet(
            ...
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
               pt = cms.vdouble(1.7, 2, 2.5,2.75, 3,3.25, 3.5, 4, 4,4.5, 5, 7, 30),
       ...
       PassingSTA_pt4 = cms.PSet(
            ...
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
              pt = cms.vdouble(1.5, 1.75, 2, 2.25, 2.5, 3, 3.5, 4, 5, 7, 30),
        ...
        PassingSTA_eta = cms.PSet(
            ...
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
               eta = cms.vdouble(-2.4,-2.1,-1.6,-0.9,0.9,1.6,2.1,2.4),
               pt = cms.vdouble(1.5,30.),
            ),
            BinToPDFmap = cms.vstring(PDFName)
        ),
