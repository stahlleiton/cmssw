...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    # IO parameters:
    InputFileNames = cms.vstring("tnp_Prod_PbPb_MC_STA_AllMB_25092015.root"),
    InputDirectoryName = cms.string("fitTkFromSta"),
    InputTreeName = cms.string("fitter_tree"),
    #numbrer of CPUs to use for fitting
    OutputFileName = cms.string("tnp_Ana_PbPb_MC_STA_AllMB_CBGPoly_14102015.root"),
    ...
    Categories = cms.PSet(
        ...
        passingAtVtx = cms.vstring("passingAtVtx", "dummy[true=1,false=0]"),
    ),
    ...
    PDFs = cms.PSet(
      ...
      twoGaussPlusPoly6v1 = cms.vstring(
       ...
       cbGausPlusPoly = cms.vstring(
        "CBShape::signal1(mass, mean[3.095,3.0,3.15], sigma[0.02, 0.01, 0.1], alpha[1.56, 1.0, 10.0], n[2, 0.5, 100.])",
        "Gaussian::signal2(mass, mean2[3.1,3.05,3.2], sigma2[0.1,0.02,1.00])",
        "SUM::signalPass(fracP[0.8,0,1]*signal1, signal2)",
        "SUM::signalFail(fracF[0.8,0,1]*signal1,signal2)",
    ...
    Efficiencies = cms.PSet(
        ...
        PassingSTA_pt1 = cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("passingAtVtx","true"),
