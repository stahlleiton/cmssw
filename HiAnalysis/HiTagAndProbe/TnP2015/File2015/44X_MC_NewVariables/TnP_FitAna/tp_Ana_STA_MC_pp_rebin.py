...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("tnp_Ana_pp_STA_MC_2absetabins.root"),
    NumCPU = cms.uint32(4),
    ...
    Efficiencies = cms.PSet(
        ...
        PassingSTA_pt1 = cms.PSet(
            ...
            BinnedVariables = cms.PSet(
              # pt = cms.vdouble(3.4, 3.75, 4, 4.25, 4.5, 5, 5.5, 6, 7, 8.5, 30),
        ...
        #     UnbinnedVariables = cms.vstring("mass"),
        #     BinnedVariables = cms.PSet(
        #        pt = cms.vdouble(2.1,3,3.25,3.5,3.75, 4, 4.5, 5, 5.5, 30),
        ...
        # ),
         PassingSTA_pt2 = cms.PSet(
            ...
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
               # pt = cms.vdouble(1.7, 2.5,3.25, 3.5,3.75, 4, 4.5, 5.5, 30),
       ...
       #      UnbinnedVariables = cms.vstring("mass"),
       #      BinnedVariables = cms.PSet(
       #        pt = cms.vdouble(1.5, 2, 2.5,3.25, 3.5,3.75,4,4.5,5, 30),
