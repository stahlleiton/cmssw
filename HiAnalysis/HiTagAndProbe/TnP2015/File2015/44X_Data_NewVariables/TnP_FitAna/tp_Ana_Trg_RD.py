...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
        ...
        OutputFileName = cms.string("tnp_Ana_Data_PbPb_MuonTrg_AllMB_20150801.root"),
        ...
        PDFs = cms.PSet(
            ...
            cbPlusPoly2nd = cms.vstring(
                ...
                "Chebychev::backgroundPass(mass, {cPass[0.12,0.11,0.13], cPass2[0.,-0.17,0.17]})",
                "Chebychev::backgroundFail(mass, {cFail[0.,-0.17,0.17], cFail2[0.,-0.17,0.17]})",
                #"Exponential::backgroundPass(mass, lp[0,-5,5])",
    ...
    Efficiencies = cms.PSet(
            ...
            PassingGlb_pt = cms.PSet(
                ...
                BinnedVariables = cms.PSet(
                    pt = cms.vdouble(1.5, 3.5, 5.5, 7.5, 10, 14, 20.0),
