...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    # IO parameters:
    InputFileNames = cms.vstring("tnp_Prod_pp_GTrkSTA_Data_24092015.root"),
    InputDirectoryName = cms.string("tpTree"),
    InputTreeName = cms.string("fitter_tree"),
    #numbrer of CPUs to use for fitting
    OutputFileName = cms.string("tnp_Ana_pp_STA_RD_4absetabins.root"),
    NumCPU = cms.uint32(1),
    ...
    PDFs = cms.PSet(
      ...
      twoGaussPlusPoly = cms.vstring(
       ...
       cbGausPlusPoly = cms.vstring(
        "CBShape::signal1(mass, mean[3.05,3.0,3.15], sigma[0.015, 0.01, 0.3], alpha[1.5, 1.0, 10.0], n[2, 0.5, 100.])",
    ...
    Efficiencies = cms.PSet(
        ...
        PassingSTA_pt1 = cms.PSet(
            ...
            BinnedVariables = cms.PSet(
              pt = cms.vdouble(3.4, 4, 4.5, 5, 5.5, 6, 7, 8.5, 30),
         ...
         PassingSTA_pt2 = cms.PSet(
            ...
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
               pt = cms.vdouble(2.1, 3, 3.5, 4, 4.5, 5.5, 30),
         ...
         PassingSTA_pt3 = cms.PSet(
            ...
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
               pt = cms.vdouble(1.7, 2.5,3,3.5, 4,5, 30),
       ...
       PassingSTA_pt4 = cms.PSet(
            ...
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
              pt = cms.vdouble(1.5, 2, 2.5,3.5,5,30),
