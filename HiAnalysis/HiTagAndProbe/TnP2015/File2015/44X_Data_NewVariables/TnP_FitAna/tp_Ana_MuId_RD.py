...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    InputFileNames = cms.vstring("file:/afs/cern.ch/user/c/chflores/work/public/TnP_2015/TP_Prod_Samples/Data/tnp_Prod_Data_PbPb_AllMB_25082015.root"),
    ...
    Efficiencies = cms.PSet(
            ...
            PassingGlb_pt = cms.PSet(
                EfficiencyCategoryAndState = cms.vstring("QualityCuts","true"),
                UnbinnedVariables = cms.vstring("mass"),
                BinnedVariables = cms.PSet(
                    pt = cms.vdouble(1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5, 5.5, 6, 6.5, 7.5, 9.5, 30),
