...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    # IO parameters:
    InputFileNames = cms.vstring("tnp_Prod_PbPb_RD_STA_AllMB_24092015.root"),
    InputDirectoryName = cms.string("fitTkFromSta"),
    InputTreeName = cms.string("fitter_tree"),
    #numbrer of CPUs to use for fitting
    OutputFileName = cms.string("tnp_Ana_PbPb_RD_STA_AllMB_GPoly_07102015.root"),
    NumCPU = cms.uint32(1),
    ...
    PDFs = cms.PSet(
      ...
      GaussPlusPoly = cms.vstring(
          "Gaussian::signal(mass, mean[3.09,3.0,3.2], sigma[0.1,0.0,1.])",
    ...
    Efficiencies = cms.PSet(
        ...
        PassingSTA_pt1 = cms.PSet(
            ...
            BinnedVariables = cms.PSet(
              pt = cms.vdouble(3.4,4, 4.5, 5, 5.5, 8.5, 30),
         ...
         PassingSTA_pt3 = cms.PSet(
            ...
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
               pt = cms.vdouble(1.7,2.5,3.5, 4.5, 5.5, 30),
