...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    # InputFileNames = cms.vstring("/afs/cern.ch/user/c/chflores/work/public/TnP_2015/TP_Prod_Samples/Data_pp/tnp_Prod_Data_pp_All_16092015.root"),
    InputFileNames = cms.vstring("/afs/cern.ch/work/e/echapon/public/TnP_2015/TP_Prod_Samples/Data_pp/tnp_Prod_Data_pp_All_16092015.root"),
    ...
    PDFs = cms.PSet(
      ...
      cbGausPlusExpo = cms.vstring(
        ...
        "Exponential::backgroundFail(mass, lf[0,-1.0,1.0])",  # same slope, they're both muons
        "efficiency[0.9,0,1]",
        "signalFractionInPassing[0.9]"
      ),
