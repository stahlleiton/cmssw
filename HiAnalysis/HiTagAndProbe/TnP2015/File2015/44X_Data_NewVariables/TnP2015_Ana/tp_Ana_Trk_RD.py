...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("tnp_Ana_RD_PbPb_MuonTrk_AllMB_20150801.root"),
    NumCPU = cms.uint32(1),
    ...
    Variables = cms.PSet(
        mass             = cms.vstring("Tag-Probe Mass", "2.0", "4.0", "GeV/c^{2}"),
    ...
    PDFs = cms.PSet(
      ...
      twoGaussPlusPoly6v1 = cms.vstring(
          ...
          "Chebychev::backgroundPass(mass, {cP[0,-.2,.2], cP2[0,-.2,.2], cP3[0,-.2,.2]})",
          "Chebychev::backgroundFail(mass, {cF[0,-.2,.2], cF2[0,-.2,.2], cF3[0,-.2,.2]})",
          "efficiency[0.9,0,1]",
          "signalFractionInPassing[0.9]"
      ),
    ),
    ...
    Efficiencies = cms.PSet(
            ...
            PassingGlb_pt = cms.PSet(
                ...
                BinnedVariables = cms.PSet(
                    pt = cms.vdouble(0, 3.5, 7., 10.5, 20.0),
