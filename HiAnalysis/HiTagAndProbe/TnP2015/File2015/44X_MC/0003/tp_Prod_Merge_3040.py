...
process.centralityFilter.selectedBins = [12,13,14,15] # 30 - 40 %
...
process.MuonTrg = cms.EDAnalyzer("TagProbeFitTreeProducer",
    ...
    #addRunLumiInfo = cms.bool(True),
    eventWeight=cms.double(325.711)
)
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("tnp_Regit_PbPb_3040.root"))
