...
# with command line options: ZMM_13TeV_TuneCUETP8M1_cfi --conditions auto:run2_mc_HIon -s GEN,SIM -n 50 --eventcontent FEVTDEBUG --relval 18000,300 --scenario HeavyIons --datatier GEN-SIM --beamspot RealisticHI2011Collision --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1_HI --magField 38T_PostLS1
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('ZMM_13TeV_TuneCUETP8M1_cfi nevts:50'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/tmp/camelia/ZMM_13TeV_TuneCUETP8M1_cfi_GEN_SIM.root'),
