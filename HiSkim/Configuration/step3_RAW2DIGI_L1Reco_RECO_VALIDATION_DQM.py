...
# with command line options: step3 --conditions auto:run2_mc_HIon -s RAW2DIGI,L1Reco,RECO,VALIDATION,DQM -n 50 --eventcontent FEVTDEBUGHLT --scenario HeavyIons --datatier GEN-SIM-RECO --beamspot RealisticHI2011Collision --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1_HI --magField 38T_PostLS1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/tmp/camelia/step2_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/tmp/camelia/step3_RECO.root'),
