...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/tmp/camelia/ZMM_13TeV_TuneCUETP8M1_cfi_GEN_SIM.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/tmp/camelia/step2_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco.root'),
